...
export default function ShesGoneBoard() {
  ...
  const s = {
    ...
    titleSub: { fontFamily: "serif", fontSize: "13px", color: "#7a6a8a", lineHeight: "2.2", marginBottom: "40px", maxWidth: "640px" },
    ...
    game: { minHeight: "100vh", padding: "28px 20px", maxWidth: "1100px", margin: "0 auto" },
